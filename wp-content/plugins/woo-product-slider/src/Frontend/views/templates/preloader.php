 ...
 * Preloader.
 *
 * This template can be overridden by copying it to yourtheme/woo-product-slider-pro/templates/preloader.php
 *
 * @link       https://shapedplugin.com/
 * @since      2.5.0
 *
 * @package    woo-product-slider-pro
 * @subpackage woo-product-slider-pro/Frontend/views
 */
