			...
			if ( $has_nav ) {
				...
				foreach ( $this->pre_tabs as $tab ) {
					...
					if ( ! empty( $tab['subs'] ) ) {
						...
						echo '<a href="#tab=' . esc_attr( $tab_id ) . '" data-tab-id="' . esc_attr( $tab_id ) . '" class="spwps-arrow">' . wp_kses_post( $tab_icon . $tab['title'] . $tab_error ) . '</a>';
						...
						echo '<li class="spwps-tab-item"><a href="#tab=' . esc_attr( $tab_id ) . '" data-tab-id="' . esc_attr( $tab_id ) . '">' . wp_kses_post( $tab_icon . $tab['title'] . $tab_error ) . '</a></li>';
					}
				}
