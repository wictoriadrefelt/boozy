			...
			<div id="bd-help-files" class="bd-help-files active" style="display: block;">
				...
				<div class="bd-panel-right">
					<div class="panel-aside panel-club">
						<a target="_blank" href="<?php echo esc_url( 'https://codecanyon.net/item/blog-designer-pro-for-wordpress/17069678?ref=solwin' ); ?>" style="display: inline-block;padding: 10px;"><img src="<?php echo esc_url( BLOGDESIGNER_URL ) . 'admin/images/blog-designer-offer.png'; ?>" alt="<?php esc_attr_e( 'Blog Designer PRO', 'blog-designer' ); ?>"/></a>
					</div>
					<div class="panel-aside panel-club">
