...
class Blog_Designer_Lite_Admin {
	...
	public function bd_add_menu() {
		...
		//add_submenu_page( 'designer_settings', esc_html__( 'News Ticker', 'blog-designer' ), esc_html__( 'News Ticker', 'blog-designer' ), 'manage_options', 'bd_news_ticker',  array( 'Blog_Designer_Lite_Ticker_Settings', 'bd_main_ticker_function' ) );
