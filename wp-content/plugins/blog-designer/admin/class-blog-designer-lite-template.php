...
class Blog_Designer_Lite_Template {
	...
	public static function bd_template_list() {
		$tempate_list = array(
			...
			'blog-carousel'   	=> array(
				...
				'demo_link'     => esc_url( 'https://wpblogdesigner.net/demo/blog-carousel-template/' ),
			),
			'blog-grid-box'   	=> array(
			...
			'ticker'   			=> array(
				...
				'demo_link'     => esc_url( 'https://wpblogdesigner.net/demo/ticker-template/' ),
			),
		);
		ksort( $tempate_list );
		return $tempate_list;
				...
				<div class="post_metadata">
					...
					if ( 0 == $display_category ) { //phpcs:ignore
						...
						<div class="category-link">
							...
							if ( $categories_list ) :
								echo ' ';
								echo str_replace(',', '', $categories_list); //phpcs:ignore
								$show_sep = true;
							endif;
							?>
						</div>
		...
		<li class="blog_template bdp_blog_template sallet_slider <?php echo esc_attr( $template_slider_content ); ?>">
			...
			<div class="blog_header">
				<div><div><div>
					...
					<?php
					if ( 0 == $display_author || 0 == $display_date || 0 == $display_comment_count || 0 == get_option( 'display_tag' ) ) { //phpcs:ignore
						?>
						<div class="metadatabox">
							<?php
							if ( 0 == get_option( 'display_tag' ) ) { //phpcs:ignore
	...
	public static function bd_media_grid_template( $settings ) {
		$col_class = self::bd_column_class( $settings );
		?>
		<div class="blog_wrap bdp_blog_template media-grid <?php echo ( '' != $col_class ) ? esc_attr( $col_class ) : ''; //phpcs:ignore ?> bdp_blog_single_post_wrapp">
			<div class="post-media">
				<?php
				if ( has_post_thumbnail() ) {
					?>
			...
			<div class="content-container">
				<div class="content-inner">
					...
					<div class="post-meta">
						...
						if ( 0 == $display_author ) { //phpcs:ignore
							?>
							<span class="author"><?php echo esc_html('Posted by','blog-designer'); ?>
								<a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>"><span><?php the_author(); ?></span></a>
							</span><br>
							<?php
						}
						if ( 0 == $display_date ) { //phpcs:ignore
							...
							?>
							<span class="postdate"><?php echo esc_html('On ','blog-designer'); ?>
			...
			<div class="post-body-div-inner">
				...
				<div class="bdp_post_content">
					...
					<div class="metadatabox">
						...
						if ( 0 == $display_comment_count || 0 == get_option('display_tag') ) { //phpcs:ignore
							if ( 0 == $display_comment_count ) { //phpcs:ignore
								if ( comments_open() ) {
									?>
									<span class="post-comment">
	...
	<li>
		<a class="blog-ticker-anchor" href="<?php the_permalink(); ?>"><?php echo the_title(); ?></a>
	</li>
	<?php
	}
