...
class Product_Grid_4{
    ...
    public function get_attributes($default = false){
        ...
        $attributes = array(
            ...
            'columns' => [
                'type' => 'object',
                'default' => (object)['lg' =>'3','md' =>'3','sm' =>'2','xs'=>'1'],
                'style' => [
                    (object)[
                         'depends' => [
            ...
            'titleTypo' => [
                'type' => 'object',
                'default' => (object)['openTypography'=>1,'size'=>(object)['lg'=>'14', 'unit'=>'px'], 'spacing'=>(object)[ 'lg'=>'0', 'unit'=>'px'], 'height'=>(object)[ 'lg'=>'22', 'unit'=>'px'],'decoration'=>'none','transform' => 'capitalize','family'=>'','weight'=>'600'],
                'style' => [
                    (object)[
                        'depends' => [
                                ...
                                $post_loop .= '<div class="wopb-block-content-wrap '.($attr['layout']?'wopb-pg-l'.$attr['layout']:'').'">';
                                        ...
                                        $image_data .= '<div class="wopb-block-image wopb-block-image-'.$attr['imgAnimation'].'">';
                                            ...
                                            if($attr["layout"] == '1' || $attr["layout"] == '2' || $attr["layout"] == '3') {
                                                ...
                                                if ( ($attr["layout"] == '1' || $attr["layout"] == '2')  && $attr['quickView'] )  {
                                        ...
                                        $content_data .= '<div class="wopb-pg-cl '.($attr['contentLayout']?'wopb-pg-cl'.$attr['contentLayout']:'').'">';
                                            if(( $attr['titleShow'] || $attr['showReview'] || $attr['catShow'] || $attr['showPrice'] ) ) {
                                                $content_data .= '<div class="wopb-product4-content">';
                                                    ...
                                                    $content_data .= '<div class="wopb-product4-content-in">';
                                                        ...
                                                        $content_data .= '<div class="wopb-pg4-content '.($attr['layout']?'wopb-pg4-content'.$attr['layout']:'').'">';
                                                            // Price
                                                            if($attr['showPrice']){
                                                            ...
                                                            if ( ($attr["layout"] == '1' || $attr["layout"] == '5' || $attr["layout"] == '6') && $attr['showCart']){
                                                                $content_data .= wopb_function()->get_add_to_cart($product, $attr['cartText'], $attr['cartActive']);
                                                            }
                                                        $content_data .= '</div>';
                                                    $content_data .= '</div>';
                                                $content_data .= '</div>';
