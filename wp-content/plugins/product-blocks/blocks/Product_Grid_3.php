                        ...
                        while ( $recent_posts->have_posts() ): $recent_posts->the_post();
                            ...
                            $post_loop .= '<div class="wopb-block-item">';
                                $post_loop .= '<div class="wopb-block-content-wrap '.($attr['layout']?'wopb-pg-l'.$attr['layout']:'').'">';
                                                ...
                                                $image_data .= '<div class="wopb-quick-cart">';
                                                    if ( ($attr["layout"] == '1' || $attr["layout"] == '3')  && $attr['showCart'] )  {
                                                        $image_data .= '<div class="wopb-product-btn">';
                                                            $image_data .= wopb_function()->get_add_to_cart($product, $attr['cartText']);
                                                        $image_data .= '</div>';
                                                    }
                                                    if ( $attr["layout"] == '2' )  {
                                                        if( $attr["quickView"] ) {
                                    ...
                                    $post_loop .= $image_data. '<div class="wopb-pg-cl '.($attr['contentLayout']?'wopb-pg-cl'.$attr['contentLayout']:'').'">' .$cat_price_data.$title_review_data . $description_data . '</div>';
