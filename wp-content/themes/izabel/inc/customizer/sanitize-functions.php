<?php
/**
 * Izabel Theme Options Sanitization Functions
 *
 * @package Izabel
 */
 ...
 */
function izabel_sanitize_select( $input, $setting ) {
 ...
 */
function izabel_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 */
function izabel_sanitize_post( $input ) {
 ...
 */
function izabel_sanitize_image( $image, $setting ) {
    /*
 ...
 * @since Izabel 1.0
 */
function izabel_sanitize_category_list( $input ) {
 ...
 *                    the setting default.
 */
function izabel_sanitize_number_range( $number, $setting ) {
 ...
 * @return string
 */
function izabel_sanitize_date_time( $input ) {
